...
public class VRC_SdkControlPanel : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        {
            useFileApi = VRC.Core.ApiFile.kDefaultUseFileAPI;
        }
...
**/
    ...
    int numClients = 1;
    bool useFileApi = VRC.Core.ApiFile.kDefaultUseFileAPI;
    ...
    void OnGUIAvatarCheck(VRCSDK2.VRC_AvatarDescriptor avatar)
    {
        ...
        if (VRCSDK2.AvatarValidation.EnforceAudioSourceLimits(avatar.gameObject))
        {
